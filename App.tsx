        ...
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Tooltip content="Reset Studio" position="bottom">
                  <button type="button" className="flex items-center gap-2 cursor-pointer group" onClick={handleReset} aria-label="Reset Studio">
            ...
            <div className="flex items-center gap-3">
              <button 
                ...
                aria-label={view === 'home' ? "Open Settings" : "Return to Home"}
              >
