...
import { purchaseSubscription, restorePurchases, saveLicense, getStoredLicense } from './services/storeService';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
      ...
      // 🛡️ SENTINEL: Use secure license check
      const storedTier = getStoredLicense();
      if (storedTier !== AppTier.FREE) setTier(storedTier);
  ...
  const handleUpgrade = async () => {
      ...
      // 🛡️ SENTINEL: Persist secure license
