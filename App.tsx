...
const App: React.FC = () => {
  ...
  useEffect(() => {
      // Skip if empty to avoid overwriting with empty state on initial load race conditions
      if (portfolioState.designs.length === 0) return;
      ...
      const timeoutId = setTimeout(saveState, 1000); // 1s debounce
